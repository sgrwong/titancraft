...
import com.titan.titancraft.TitaniumTitanEntity;
...
public class TitaniumTitanModel<T extends TitaniumTitanEntity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation	(new ResourceLocation(TitanCraft.MODID, "titanium_titan"), "main");
	...
	public TitaniumTitanModel(ModelPart root) {
