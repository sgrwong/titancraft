...
import com.titan.titancraft.AluminiumTitanEntity;
...
public class AluminiumTitanModel<T extends AluminiumTitanEntity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TitanCraft.MODID, "aluminium_titan"), "main");
	...
	public AluminiumTitanModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(28, 53).addBox(-10.0F, 12.0F, -6.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 11.0F, 0.0F));

		PartDefinition bone = rightLeg.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 13).addBox(-10.5F, 0.5F, 0.25F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 4.3824F, -0.7805F, -0.3054F, 0.0F, 0.0F));
		...
		.texOffs(13, 47).addBox(5.0F, 12.0F, -6.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 11.0F, 0.0F));

		PartDefinition bone2 = leftLeg.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 0).addBox(6.0F, 4.8824F, 0.4695F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));
